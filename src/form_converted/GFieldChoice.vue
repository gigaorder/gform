...
export default {
  ...
  setup(props, {emit}) {
    ...
    return genScopeId(() => <g-col xs12>
          {(choiceExist.value) &&
          <div>
            <g-col xs12>
              <g-field field={choiceField.value} model={choiceModel.value} onRemoveField={removeChoice} inArray={true}
                       rootModel={props.rootModel} path={choicePath.value} noLayout={props.noLayout} v-slots={{
                'action': genScopeId(() =>
